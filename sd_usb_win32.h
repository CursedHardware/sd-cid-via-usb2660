...
inline uint8_t HIBYTE(uint16_t value) { return ((value & 0xFF00) >> 8); }

inline uint8_t LOBYTE(uint16_t value) { return (value & 0xFF); }

inline uint16_t HIWORD(uint32_t value) { return ((value & 0xFFFF0000) >> 16); }

inline uint16_t LOWORD(uint32_t value) { return (value & 0xFFFF); }
